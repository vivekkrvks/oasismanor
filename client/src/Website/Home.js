			...
			feathers: [
				{
					...
					line:
						"Oasis manor is a world-class, refreshingly-new concept in senior citizens' community living, for all kind of older adults who need a short-term or permanent stay.",
				...
				},
				{
					...
					line:
						"Diagnosis of Alzheimer disease requires both the the presence of dementia and regular doctor checkup that we offer on demand at very affordable price.",
				...
				},
				{
					...
					line:
						"In Oasis Manor, we believe that healthy & hygienic meal is the primary need for each person, hence we serve you fruits & green vegetables on regular basis.",
				...
				},
				{
					...
					label: "Respite Care",
					line:
						"A safe, familiar, and stimulating environment designed for seniors living with complete care. Oasis Manor is dedicated to Respite care of our all guest personally.",
					title: "All Amenities",
				},
				{
					...
					line:
						'Professional yoga & meditation camps in "Oasis Manor" helps you in balancing the relationship between body and mind. Online training series is also available for our guest.',
				...
				},
				{
					...
					line:
						"Keeping you physically healthy and fit is our prime goal, so we regularly do the necessary medical tests and arrange appropriate doctor 24 * 7 (if needed).",
						...
						<Grid container spacing={4}>
							...
							<Grid item xs={12} sm={6} className={classes.topPara}>
								...
								<Typography gutterBottom variant="body1">
									You can place online requests for all activities and services in the Oasis Manor web portal, which can also be visible to your
									relatives also.
								</Typography>
